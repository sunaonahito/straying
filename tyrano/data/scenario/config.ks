...
; タイトル画面からMENUへ来た場合のUIを再表示
$('.straying-title-button').show();
$('#straying-title-lang').show();
$('#straying-title-menu').show();
$('#straying-title-logo').show();
$('#straying-title-copyright').show();

; ゲーム中からMENUへ来た場合のLANGボタンを再表示
$('#straying-lang-button').show();

; 言語選択パネル自体は閉じた状態にしておく
